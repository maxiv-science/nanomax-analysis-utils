...
steps = args.steps
flipx = 1  #args.flipx #It is None, I do not know where is defined
flipy = 1  #args.flipy # It is initially None, I do not know where is defined
print(flipx, flipy)
...
### Object
fig, ax = plt.subplots(nrows=2, figsize=(6,10), sharex=True, sharey=True)
